...
def run_replay(cfg):
    ...
    # Initiliaze list of VAE models if we have generative replay and a list of models
    if(cfg['cl_method']=='generative_replay' and cfg['single_vae']==True): 
...
if __name__ == '__main__':
    ...
    task_accuracies = run_replay(cfg)
